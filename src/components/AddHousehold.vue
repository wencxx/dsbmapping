    ...
    <div class="absolute top-0 left-0 w-screen h-screen bg-black/55 flex items-center justify-center">
        <form @submit.prevent="addHousehold" class="bg-white w-1/2 h-fit rounded-md p-5 space-y-7">
            ...
            <div class="col-span-3 flex justify-end items-center gap-x-3 mt-5">
                ...
                <button v-if="!addingHousehold" class="w-1/6 border py-1 rounded bg-green-500 text-white hover:bg-green-600">Add Household</button>
                <button v-else class="w-1/6 border py-1 rounded bg-green-500 text-white hover:bg-green-600">Adding Household</button>
            </div>
        </form>
